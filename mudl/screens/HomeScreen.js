...
class HomeScreen extends Component {
  ...
  render() {
    ...
    if (this.state.moods[0].tertiary_emotion){
     ...
     button = <FeelingButton class={item.secondary_emotion}  onPress={(e) => this.handlePress(e, item.primary_emotion, item.secondary_emotion)} key={item.secondary_emotion} emotion={item.secondary_emotion}></FeelingButton>
    }else{
